                                ...
                                <Row>
                                    <Col lg={12}>
                                        <div className="agency-home-title text-center text-white mx-auto">
                                            <h1 className="display-8 mb-4">ENTERPRISE SOFTWARE DEVELOPMENT</h1>
                                            <p className="text-light f-17" style={{"WebkitTextFillColor":"black", "fontSize": "25px"}} >Products to Empower your Business</p>
                                            <div className="watch-video mt-5">
                                                ...
                                                <ModalVideo channel='youtube' isOpen={this.state.isOpen} videoId='5gcqvS0taUE' onClose={() => this.setState({isOpen: false})} />
